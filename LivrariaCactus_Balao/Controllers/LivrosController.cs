...
using LivrariaCactus_Balao.AcessoDados;
using LivrariaCactus_Balao.Models;
using Microsoft.AspNet.Identity;
using Microsoft.AspNet.Identity.Owin;
using Microsoft.Owin.Security;

namespace LivrariaCactus_Balao.Controllers
{
    [Authorize]
    public class LivrosController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Alugar([Bind(Include = "Id,Titulo,Autor,AnoEdicao,Valor,GeneroId,Alugado")] Livro livro)
        {
            if (ModelState.IsValid)
            {
                if (livro.Alugado == "n")
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Devolver([Bind(Include = "Id,Titulo,Autor,AnoEdicao,Valor,GeneroId,Alugado")] Livro livro)
        {
            if (ModelState.IsValid)
            {
                if (livro.Alugado == "n")
